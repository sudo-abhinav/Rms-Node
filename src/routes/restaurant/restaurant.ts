...
import {  fetchAllrestaurantsWithRole } from "../../handler/common";
...
restaurant.get("/restaurant" , authMiddleware , shouldHaveRole(['admin','sub-admin']) ,fetchAllrestaurantsWithRole )
